	...
	"data":{
...

		{
			...
			[{
				...
				"evalJs":"$(\"[for='part_job'] span\").click();",
				...
				"evalJs":"$('#ueditor_0').contents().find('body.view').html('这里是职位描嘻嘻嘻嘻嘻嘻谢谢谢谢谢谢谢谢谢嘻嘻嘻嘻嘻��&#65533;,巴拉巴拉<h3>html</h3><hr>');",
				...
				"evalJs":"$('input#DateEnd').val('2018-3-11');",
